...
|---|---|---|---|---|---|---|---|---|---|---|
| Link, nav links ×9, Sign out | as dashboard.md | as dashboard.md | `aria-current="page"` on Sourcing | — | — | — | — | Yes | lists the requests with where each stands, and every link goes somewhere | ✅ |
