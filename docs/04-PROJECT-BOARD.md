...
| ARB-061 | Pages: login, dashboard, feed, approvals, settings (accounts, scanners, margin rules, fee table, FX, live-mode switch with confirm) | 060, 044 | — | Every button audited per 05; Playwright covers every button and form | IN PROGRESS (session …JmtXArNa, claimed 22/09/2026 22:50 UTC; took over the …V4PPWs claim of 19:51 UTC after 3 h without a push, D-034) | |
