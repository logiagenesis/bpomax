...
| ARB-041 | Margin engine with fee table, FX buffer, min rules; every input line stored | 040 | T-02, D-02, D-03, B-10 | Hand-calculated test cases pass to the cent for fixed, hourly, multi-currency | IN PROGRESS (claimed 22/09/2026 18:48 SAST+0 by session …V4PPWs. The engine reads the org's settings and a fee table with source URL and date; while T-02, D-02 or D-03 are unanswered it records `blocked` naming the missing rule, never a default) | |
