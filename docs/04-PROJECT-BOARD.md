...
| ARB-050 | Telegram bot: link via one-time code, /queue /pause /resume /stats, Approve/Edit/Reject cards | 043 | B-09 | Approve from Telegram submits in sandbox; Edit replaces text; Reject records reason | IN PROGRESS (claimed 22/09/2026 19:28 SAST+0 by session …V4PPWs. The conversation engine, linking, commands and cards are mechanism, tested against a scripted Telegram; the token is B-09 and the sandbox submission is C-02) | |
